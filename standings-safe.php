...
<div class="standings-section-nav">
    <a href="standings.php?season_id=<?= (int)$seasonId ?>" class="standings-section-nav-link standings-section-nav-link-active">
        Standings
    </a>

    <a href="standings-rounds.php?season_id=<?= (int)$seasonId ?>" class="standings-section-nav-link">
        Round
    </a>

    <a href="standings-leaders.php?season_id=<?= (int)$seasonId ?>" class="standings-section-nav-link">
        Leaders
    </a>

    <a href="standings-trends.php?season_id=<?= (int)$seasonId ?>" class="standings-section-nav-link">
        Trends
    </a>
</div>
<div class="wrapper">
		...
		<div class="game-page-topline game-page-topline-compact standings-page-topline">
			<details class="game-season-switcher-menu standings-season-switcher-menu">
				...
				<div class="game-season-switcher-panel standings-season-options-panel">
					<a href="standings.php?season_id=all&sort=<?= htmlspecialchars($sortKey) ?>&dir=<?= htmlspecialchars($sortDir) ?>" class="standings-season-option">
						<span class="standings-season-switcher-league"><?= htmlspecialchars(mlGetLeagueName($pdo)) ?></span>
						<span class="standings-season-switcher-separator">•</span>
					...
					<?php foreach ($seasonList as $seasonOption): ?>
						<a href="standings.php?season_id=<?= (int)$seasonOption['SeasonID'] ?>&sort=<?= htmlspecialchars($sortKey) ?>&dir=<?= htmlspecialchars($sortDir) ?>" class="standings-season-option">
							<span class="standings-season-switcher-league"><?= htmlspecialchars(mlGetLeagueName($pdo)) ?></span>
							<span class="standings-season-switcher-separator">•</span>
							<span class="standings-season-switcher-season">
