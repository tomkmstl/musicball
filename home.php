...
<main>
            ...
            <div class="marketing-product-preview" aria-label="Musicball product preview">
                <article class="marketing-app-card marketing-round-preview">
                    ...
                    <div class="marketing-player-line">
                        ...
                        <div class="marketing-avatar-row" aria-hidden="true"><span></span><span></span><span></span><span></span><span></span><span></span></div>
                    </div>
                    <div class="marketing-player-line">
                        <strong>still researching:</strong>
                        <div class="marketing-avatar-row marketing-avatar-row-alt" aria-hidden="true"><span></span><span></span><span></span><span></span><span></span></div>
                    </div>
    ...
    <section id="how-it-works" class="marketing-section marketing-section-light marketing-how-section">
        ...
        <div class="marketing-container">
            <div class="marketing-process-grid">
                <article>
                    <div class="marketing-process-icon"><img src="<?= htmlspecialchars(mlAssetUrl('assets/icons/marketing/submit-song.svg')) ?>" alt="Submit"></div>
                    <h3>1. Submit</h3>
                    <p>Pick a song that fits the round theme and submit before the deadline.</p>
                </article>
                <article>
                    <div class="marketing-process-icon"><img src="<?= htmlspecialchars(mlAssetUrl('assets/icons/marketing/vote.svg')) ?>" alt="Vote"></div>
                    <h3>2. Vote</h3>
                    <p>Rank your favorite songs. Points are awarded automatically.</p>
                </article>
                <article>
                    <div class="marketing-process-icon"><img src="<?= htmlspecialchars(mlAssetUrl('assets/icons/marketing/results.svg')) ?>" alt="Results"></div>
                    <h3>3. Results</h3>
            ...
            <div class="marketing-info-card marketing-season-card">
                <div>
                    <div class="marketing-info-icon"><img src="<?= htmlspecialchars(mlAssetUrl('assets/icons/marketing/seasons.svg')) ?>" alt="Seasons"></div>
                    <h3>Seasons</h3>
                    <p>Each league plays through themed rounds that build one shared playlist over time.</p>
                </div>
                <ul>
                    <li>Weekly rounds keep it fresh</li>
                    <li>Season standings create friendly stakes</li>
                    <li>History and stats preserve every league</li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <section id="features" class="marketing-section marketing-discord-section">
        <div class="marketing-container marketing-discord-grid">
            <div>
                <div class="marketing-discord-lockup">
                    <img src="<?= htmlspecialchars(mlAssetUrl('assets/icons/marketing/discord.svg')) ?>" alt="Discord" class="marketing-discord-logo">
                    <div>
            ...
            <div class="marketing-discord-card marketing-discord-visual" aria-label="Discord notification preview">
                <div class="marketing-discord-topbar"><span class="marketing-discord-hash">#</span><span>musicball</span><span class="marketing-discord-dots">•••</span></div>
        ...
        <div class="marketing-container">
            <div class="marketing-info-card marketing-discord-note">
                <div class="marketing-info-icon marketing-info-icon-discord"><img src="<?= htmlspecialchars(mlAssetUrl('assets/icons/marketing/discord.svg')) ?>" alt="Discord"></div>
                <div><h3>Less friction. More music.</h3><p>Discord keeps your league connected—so you can focus on discovering new music together.</p></div>
            </div>
        </div>
    </section>
    ...
    <section class="marketing-section marketing-section-light">
        <div class="marketing-container">
            ...
            <div class="marketing-feature-grid">
                <article><div class="marketing-mini-shot marketing-mini-shot-dark">Active Round</div><h3>Active Rounds</h3><p>See who’s in, who’s working on it, and what’s next.</p></article>
                <article><div class="marketing-mini-shot marketing-mini-shot-dark">Standings</div><h3>Standings</h3><p>Track points, wins, and bragging rights.</p></article>
                <article><div class="marketing-mini-shot marketing-mini-shot-light">Playlists</div><h3>Playlists</h3><p>Every round becomes part of something you keep.</p></article>
                <article><div class="marketing-mini-shot marketing-mini-shot-dark">Season Builder</div><h3>Season Builder</h3><p>Customize rounds, themes, eras, and formats.</p></article>
            </div>
        </div>
    </section>
        ...
        <div class="marketing-container marketing-start-grid">
            <div class="marketing-start-copy">
                ...
                <div class="marketing-start-steps">
                    <article><span>1</span><div><h3>Create your league</h3><p>Name your league and set the basics.</p></div></article>
                    <article><span>2</span><div><h3>Invite your friends</h3><p>Send invites and build your roster.</p></div></article>
                    <article><span>3</span><div><h3>Pick your first round</h3><p>Choose from ready-made themes or create your own.</p></div></article>
                </div>
            </div>
